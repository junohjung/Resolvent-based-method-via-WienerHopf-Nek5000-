### makefile automatically created by makenek 12/17/2020 09:23:24 ###
BINNAME=nek5000
LIBNAME=libnek5000.a
CASENAME:=Nek_ResEstimationandControl
CASEDIR:=/home/junoh/Nek5000/run/NL_DFA_1em4
S:=/home/junoh/Nek5000/core
SCMT:=/home/junoh/Nek5000/core/cmt
OPT_INCDIR=./
OBJDIR=obj
MPI:=1
CMT:=0
NEKNEK:=0
FC:=/home/junoh/Nek50001/bin/mpif77
CC:=/home/junoh/Nek50001/bin/mpicc
FFLAGS:= -fdefault-real-8 -fdefault-double-8 -cpp
CFLAGS:=
PPPO=
PPS= MPI UNDERSCORE TIMER
USR:=
USR_LFLAGS:= -L/home/junoh/Nek5000/3rd_party/gslib/lib -lgs
VISIT:=0
VISIT_IFLAGS=
VISIT_LFLAGS=
